...
Feed shape:
    <list>
      <message>
        <ID>…</ID>
        <INCIDENT_NUMBER>IN-26-03933</INCIDENT_NUMBER>
        <INCIDENT_HEADING_EN>Road Incident</INCIDENT_HEADING_EN>
        <INCIDENT_DETAIL_EN>watermain emergency works</INCIDENT_DETAIL_EN>
        <LOCATION_EN>Wai Wah Street (both bounds)</LOCATION_EN>
        <DISTRICT_EN>Wong Tai Sin</DISTRICT_EN>
        <DIRECTION_EN/>
        <NEAR_LANDMARK_EN>Tsz Wan Shan Road</NEAR_LANDMARK_EN>
        <BETWEEN_LANDMARK_EN/>
        <ANNOUNCEMENT_DATE>2026-06-07T03:42:00</ANNOUNCEMENT_DATE>
        <INCIDENT_STATUS_EN>UPDATED</INCIDENT_STATUS_EN>
        <CONTENT_EN>All lanes of Wai Wah Street …</CONTENT_EN>
        <LATITUDE>22.345</LATITUDE>
        <LONGITUDE>114.205</LONGITUDE>
      </message>
      …
    </list>
"""
...
def fetch_traffic_advisories(district: str | None = None) -> dict:
    """Fetch live Transport Department incident feed.

    If `district` is given, return incidents whose district / location /
    landmarks contain that substring. If nothing matches, return the
    most recent feed-wide so the model has situational awareness.
    """
    items = _parse_feed(_fetch_feed())
    total = len(items)
